        ...
        () => {
            ...
            mm.add(
                ...
                (context) => {
                    ...
                    const bus =
                        diagramRef.current?.querySelector("[data-hub-bus]") ??
                        null;
                    const stubs =
                        gsap.utils.toArray<HTMLElement>("[data-hub-stub]");
                    const hub =
                        diagramRef.current?.querySelector("[data-hub-badge]") ??
                        null;

                    if (reduceMotion) {
                        gsap.set(cards, { autoAlpha: 1, y: 0, scale: 1 });
                        gsap.set([bus, ...stubs].filter(Boolean), {
                            scaleX: 1,
                            scaleY: 1,
                        });
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Icon
                                        ...
                                        stroke={1.25}
                                        style={{
                                            transform: `rotate(${CARD_ROTATIONS[key]}deg)`,
                                        }}
                                    />
